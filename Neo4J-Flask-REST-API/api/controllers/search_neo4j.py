...
import ast
import json
def export_one_object_same_event(list_label, list_object, list_rel, list_name_event, limit, conditions, follow):
    # # SQL Select
    test1 = ""
...
def search_neo4j_by_json(conditions):
    # conditions_dict = ast.literal_eval(conditions)
    list_node = []
    list_rel = []
    node_sql=""
    rels_sql=""
...
if __name__ == "__main__":
    ...
    print(test.get("relationships"))
    # ((n.name='Viet Nam' or n.name='China') and (n.type = 'Ko co' or n.type = 'Ko biet')) or ((n.name='Trump' or n.name='Bình') and (
    #     n.type = 'Leader')) (n.date='2019-10-10;2021-10-10')

# (((n.name='Viet Nam') and (n.type='o co'))  or ((n.name='Trump') and (n.type='Leader'))  or ((datetime(n.date_time) >= datetime('2019-10-10') and datetime(n.date_time) <= datetime('2021-10-10')) and (n.name='Su kien')) )